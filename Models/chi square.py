...
sos_updated_file['positive_status'] = np.vectorize(
    makeaone)(sos_updated_file['entitystatus'])


'''
sum the data to the month
'''
mon_sum_total = sos_updated_file.groupby('entityformdatemon', as_index=False)[
    'rowcount', 'positive_status'].sum()
