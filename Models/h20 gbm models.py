...
'''
sos_gbm_v1.train(sos_df_X, sos_df_y, training_frame=train,
...
sos_gbm_v2.train(sos_df_X, sos_df_y, training_frame=train,
                 validation_frame=valid)
...
sos_gbm_v3.train(sos_df_X, sos_df_y, training_frame=train,
                 validation_frame=valid)
sos_gbm_v3.logloss
